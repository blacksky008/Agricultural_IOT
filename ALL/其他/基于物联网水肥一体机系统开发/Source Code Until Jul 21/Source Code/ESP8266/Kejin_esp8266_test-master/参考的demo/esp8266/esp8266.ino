...
#define PRODUCT_KEY     "a1Md3qtpbCQ"//替换自己的PRODUCT_KEY
#define DEVICE_NAME     "text1"//替换自己的DEVICE_NAME
#define DEVICE_SECRET   "9008ZVXsb7Ula6vhAEXZ9td6izpGDYRh"//替换自己的DEVICE_SECRET
#define REGION_ID       "cn-shanghai"//默认cn-shanghai

#define WIFI_SSID       "xiaokai"//替换自己的WIFI
#define WIFI_PASSWD     "12345678k"//替换自己的WIFI
