...
//AliyunIoTSDK::bindData("relay_status_0",relay_status_0);
//AliyunIoTSDK::bindData("relay_status_2",relay_status_2);
//AliyunIoTSDK::bindData("relay_status_3",relay_status_3);
