...
byte mac[] = {0xDE, 0xAD, 0xBE, 0xEF, 0x00, 0x01}; //自定义mac地址，不会冲突即可
IPAddress ip(192,168,3,35); //使用DHCPAddressPrinter扫描出

  //设置产品和设备的信息，从阿里云设备信息里查看
#define PRODUCT_KEY     "a1VJEioFKJM"//替换自己的PRODUCT_KEY
#define DEVICE_NAME     "surveillance_node_1"//替换自己的DEVICE_NAME
#define DEVICE_SECRET   "2a5ed44eb78b806dd4e866206926f650"//替换自己的DEVICE_SECRET
