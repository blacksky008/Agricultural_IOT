...
byte mac[] = {0xDE, 0xAD, 0xBE, 0xEF, 0xFE, 0x03 }; //自定义mac地址，不会冲突即可
IPAddress ip(192,168,1,229); //使用DHCPAddressPrinter扫描出

//设置产品和设备的信息，从阿里云设备信息里查看
#define PRODUCT_KEY     "a1PkRgl2HMK"//替换自己的PRODUCT_KEY
#define DEVICE_NAME     "Arduino_wallplants"//替换自己的DEVICE_NAME
#define DEVICE_SECRET   "d3a6007ae7c479c439ae30d561e91bd6"//替换自己的DEVICE_SECRET
